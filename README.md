...
| Requirement                                                                    | Rationale for Data Visualisation Tasks                                                                                                                                                | Dashboard Item                                                  |  Manual Test                                   | Expected Outcome                                                               | Result |
| ------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------- | ----------------------------------------------- | ----------------------------------------------------------------------------- | ------------- |
| Business Requirement 1 – The client is interested in conducting a study to visually differentiate a healthy cherry leaf from one affected by powdery mildew.      | Average image calculation, Image variability analysis, different image comparison & image montage creattion | Navbar                                                          | Choose dedicated button          | Open Assigned Page                      | All Passed       |
...
|                                                                                |                 | Navbar                                                          | Selecting button for Project Hypotheses         | Project Hypothesis page opens                                                 | Pass        |
| Business Requirement 2 – The client is interested in predicting if a cherry leaf is healthy or contains powdery mildew using an ML system. | Data processing             | Navbar                                                          | Choose dedicated button             | Open Assigned Page                                                    | All Passed       |
|                                                                                |                                                                                                                                                           | Link to Kaggle on Mildew Detector page                          | Click on link                                   | Kaggle page for dataset opens                                                 | Pass        |
...
|                                                                                |                                                                                                                                                           | Box for uploading data                                          | Repeat prior two items for multiple images      | See report displaying analysis of all the images                              | Pass        |
|                                                                                |                                                                                                                                                           | Image analysis report                                           | Click button to download CSV report of analysis | Report is downloaded containing the results shown on dashboard                | Pass        |
