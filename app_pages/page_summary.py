...
def page_summary_body():
    ...
    st.info(
        ...
        f"* Powdery Mildew is a common fungal disease that affects a wide "
        f"range of plants, causing a white or gray powdery growth on the "
        f"leaves.\n"
        ...
        f"* These images were carefully curated to help train a machine "
        f"learning model to accurately classify the presence or absence of "
        f"the disease."
    )

    st.write(
        f"* For additional information, please visit and **read** the "
        f"[Project README file](https://github.com/TafadzwaMangena/mildew-"
    ...
    st.success(
        ...
        f"* 2 - The client wants to accurately predict whether a cherry leaf "
